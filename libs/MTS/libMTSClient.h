...
extern "C" {
    ...
    extern double MTS_NoteToFrequency(MTSClient *client, int midinote, char midichannel);
    extern double MTS_RetuningInSemitones(MTSClient *client, int midinote, char midichannel);
    extern double MTS_RetuningAsRatio(MTSClient *client, int midinote, char midichannel);
    ...
    // Returns the period ratio the current scale
    extern double MTS_GetPeriodRatio(MTSClient *client);
    
    // For information about keyboard mapping
